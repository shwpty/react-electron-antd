  ...
  stream.on('end', async () => {
    if (headers[":method"] === 'GET') {
      ...
      if (requestData.operation === 'clear') {
        ...
        stream.respond({ ":status": 200 });
        stream.end('{"cluster":[{"nodeid":"1","ip:port":"10.10.192.56:7701","master":1,"state":2,"replica":[1,2 ]},{"nodeid":"2","ip:port":"10.10.176.64:7702","master":0,"state":3,"replica":[1,2 ]},{"nodeid":"3","ip:port":"10.10.192.56:7703","master":1,"state":2,"replica":[3,4 ]},{"nodeid":"4","ip:port":"10.10.176.64:7704","master":0,"state":3,"replica":[3,4 ]},{"nodeid":"5","ip:port":"10.10.192.56:7705","master":0,"state":1,"replica":[5,6 ]},{"nodeid":"6","ip:port":"10.10.176.64:7706","master":0,"state":1,"replica":[5,6 ]}],"pendingnode":"5,6","runningnode":"1,2,3,4","slotlist":[       {          "NodeId" : 1,          "Slot" : [ 0, 99 ]       },       {          "NodeId" : 3,          "Slot" : [ 100, 200 ]       }    ]}');
        ...
        stream.respond({ ":status": 200 });
        stream.end('{"Replica" : [ 1, 2 ],"SlotList" : [{"NodeId" : 1,"Slot" : [ 0, 200 ]}]}');
